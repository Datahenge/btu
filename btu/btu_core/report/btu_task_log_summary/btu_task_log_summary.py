...
"""Script Report: most recent log entry per enabled BTU Task Schedule."""
...
def get_data() -> list[dict[str, Any]]:
	"""Fetch one row per enabled schedule; hours-since computed in Python."""
	rows = frappe.db.sql(
		"""
		SELECT
			TaskSchedule.name,
